...
public class AppointmentController {
    ...
    public ResponseEntity<List<AppointmentResponse>> getConfirmedAppointmentsByCompany(
    ...
    public ResponseEntity<AppointmentResponse> patchAppointmentBySlug(@PathVariable String companyName,
            @PathVariable String appointmentSlug, @RequestBody @Valid AppointmentUpdateDTO appointmentUpdateDTO) {
        Appointment appointment = appointmentService.updateAppointment(appointmentUpdateDTO, companyName,
                appointmentSlug);
    ...
    public ResponseEntity<AppointmentResponse> createAppointment(@PathVariable String companyName,
    ...
    public ResponseEntity<Void> deleteAppointment(@PathVariable String companyName,
        ...
        if (loggedEntity instanceof User user) {
            if (user.getCompany() == null) {
                throw new ResponseStatusException(HttpStatus.UNAUTHORIZED,
                        "User is a client, cannot delete any appointment");
            }
        ...
        if (!companyAppointments.contains(appointment)) {
            throw new ResponseStatusException(
                    ...
                    "Appointment " + appointment.getSlug() + " not in " + companyName + " appointments");
        }
